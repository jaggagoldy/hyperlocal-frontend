...
export default function CreateConsumerProfilePage() {
  ...
  const handleFinish = async () => {
    ...
    setLoading(true);
    try {
      // Add consumer profile using dual-profile endpoint
      const res = await apiClient.post('/auth/add-profile', {
      ...
      toast.success('Consumer account created! You can now book services.');
      router.push('/explore');
    } catch (error: any) {
            ...
            <form onSubmit={handleStep1} className="space-y-8">
              <div>
                ...
                <p className="text-zinc-500 text-base leading-relaxed">
                  You are currently a Vendor. Let's set up your consumer profile so you can book other services. What should we call you?
                </p>
              </div>
